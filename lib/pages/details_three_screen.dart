...
class DetailsThree extends StatefulWidget {
  ...
  ItemThree productthree;
  DetailsThree({required this.productthree});

  @override
  State<DetailsThree> createState() => _DetailsThreeState();
}
        ...
        body: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Image.asset(widget.productthree.imagepath),
                //    fit: BoxFit.cover
                const SizedBox(
                  height: 19,
                ),
                Text(
                  "\$${widget.productthree.price}",
